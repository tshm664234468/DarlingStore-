...
NSString *const kZYBaseClassStatus = @"status";
...
- (instancetype)initWithDictionary:(NSDictionary *)dict
{
    ...
    if(self && [dict isKindOfClass:[NSDictionary class]]) {
            self.status = [[self objectOrNilForKey:kZYBaseClassStatus fromDictionary:dict] doubleValue];
...
- (NSDictionary *)dictionaryRepresentation
{
    ...
    [mutableDict setValue:[NSNumber numberWithDouble:self.status] forKey:kZYBaseClassStatus];
...
- (id)initWithCoder:(NSCoder *)aDecoder
{
    ...
    self.status = [aDecoder decodeDoubleForKey:kZYBaseClassStatus];
...
- (void)encodeWithCoder:(NSCoder *)aCoder
{
    ...
    [aCoder encodeDouble:_status forKey:kZYBaseClassStatus];
